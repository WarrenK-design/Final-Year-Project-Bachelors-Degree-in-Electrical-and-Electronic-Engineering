...
file_handler = logging.FileHandler('/home/openhabian/Environments/env_1/openHAB_Proj/lib/logs/control_loop_one.log') #Get a file handler
...
async def main(meter,things):
        ...
        while True:
            ...
            # Query the meter_values table in the community_grid database for meter 192.168.0.116
            ...
            for plug_ID, plug in things.items():
                ...
                if voltage>=230:
                    ...
                    # If the plug is already on then dont send another request it will fill up the queue
                ...
                # Volatge is below or equal to 225 V then turn off
                    ...
                    # If plug is already off then dont send another request it will fill up the queue 
                    else:
