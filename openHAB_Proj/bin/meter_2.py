...
file_handler = logging.FileHandler('/home/openhabian/Environments/env_1/openHAB_Proj/lib/logs/meter_2.log') #Get a file handler
...
#os.chmod('/home/openhabian/Environments/env_1/openHAB_Proj/lib/logs/meter_2.log', 0o777)
...
with open('/home/openhabian/Environments/env_1/openHAB_Proj/lib/config.json') as json_file:
    ...
    try: 
        ...
        logger.exception("meter_2.py will not be executed, no configuration for 'meter_2' in config.json\nTracback Error shown below")
        sys.exit() 
    things = list()
...
loop.run_until_complete(main(meter_2,things))