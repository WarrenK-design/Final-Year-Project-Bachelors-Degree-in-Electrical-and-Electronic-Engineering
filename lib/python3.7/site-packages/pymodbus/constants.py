...
class Defaults(Singleton):
    ...
    .. attribute:: UnitId
       ...
       The modbus subordinate addrss.  Currently this is set to 0x00 which
       means this request should be broadcast to all the subordinate devices
    ...
    .. attribute:: ZeroMode
       ...
       Indicates if the subordinate datastore should use indexing at 0 or 1.
       More about this can be read in section 4.4 of the modbus specification.

    .. attribute:: IgnoreMissingSubordinates

       In case a request is made to a missing subordinate, this defines if an error
       should be returned or simply ignored. This is useful for the case of a
       serial server emulater where a request to a non-existant subordinate on a bus
    ...
    Stopbits            = 1
    ZeroMode            = False
    IgnoreMissingSubordinates = False
    ReadSize            = 1024
...
class ModbusStatus(Singleton):
    ...
    .. attribute:: SubordinateOn

       This indicates that the given modbus subordinate is running

    .. attribute:: SubordinateOff

       This indicates that the given modbus subordinate is not running
    '''
    Waiting  = 0xffff
    Ready    = 0x0000
    On       = 0xff00
