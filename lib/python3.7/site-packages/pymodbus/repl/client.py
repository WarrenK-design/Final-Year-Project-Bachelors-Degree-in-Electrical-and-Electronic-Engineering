...
from pymodbus.diag_message import (
                                   ...
                                   ReturnSubordinateMessageCountRequest,
                                   ReturnSubordinateNoResponseCountRequest,
                                   ReturnSubordinateNAKCountRequest,
                                   ReturnSubordinateBusyCountRequest,
                                   ReturnSubordinateBusCharacterOverrunCountRequest,
...
class ExtendedRequestSupport(object):
    ...
    def read_coils(self, address, count=1, **kwargs):
        """
        Reads `count` coils from a given subordinate starting at `address`.

        :param address: The starting address to read from
        :param count: The number of coils to read
        :param unit: The subordinate unit this request is targeting
    ...
    def read_device_information(self, read_code=None,
        ...
        """
        Read the identification and additional information of remote subordinate.
    ...
    def report_subordinate_id(self, **kwargs):
        """
        Report information about remote subordinate ID.

        :param unit: The subordinate unit this request is targeting
        :return:
        """
        request = ReportSubordinateIdRequest(**kwargs)
        resp = self.execute(request)
        if not resp.isError():
            return {
                'function_code': resp.function_code,
    ...
    def return_bus_com_error_count(self, data=0, **kwargs):
        ...
        received by remote subordinate.
    ...
    def return_bus_exception_error_count(self, data=0, **kwargs):
        ...
        returned by remote subordinate.
    ...
    def return_subordinate_message_count(self, data=0, **kwargs):
        """
        ...
        :return:
        """
        request = ReturnSubordinateMessageCountRequest(data, **kwargs)
        return self._execute_diagnostic_request(request)

    def return_subordinate_no_response_count(self, data=0, **kwargs):
        """
        Diagnostic sub command, Return count of No responses  by remote subordinate.

        :param data: Data field (0x0000)
        :param unit: The subordinate unit this request is targeting
        :return:
        """
        request = ReturnSubordinateNoResponseCountRequest(data, **kwargs)
        return self._execute_diagnostic_request(request)

    def return_subordinate_no_ack_count(self, data=0, **kwargs):
        """
        ...
        :return:
        """
        request = ReturnSubordinateNAKCountRequest(data, **kwargs)
        return self._execute_diagnostic_request(request)

    def return_subordinate_busy_count(self, data=0, **kwargs):
        """
        ...
        :return:
        """
        request = ReturnSubordinateBusyCountRequest(data, **kwargs)
        return self._execute_diagnostic_request(request)

    def return_subordinate_bus_char_overrun_count(self, data=0, **kwargs):
        """
        Diagnostic sub command, Return count of messages not handled \
         by remote subordinate due to character overrun condition.

        :param data: Data field (0x0000)
        :param unit: The subordinate unit this request is targeting
        :return:
        """
        request = ReturnSubordinateBusCharacterOverrunCountRequest(data, **kwargs)
        return self._execute_diagnostic_request(request)
