...
class ModbusExceptions(Singleton):
    ...
    IllegalAddress          = 0x02
    IllegalValue            = 0x03
    SubordinateFailure            = 0x04
    Acknowledge             = 0x05
    SubordinateBusy               = 0x06
...
class IllegalFunctionRequest(ModbusRequest):
    """
    Defines the Modbus subordinate exception type 'Illegal Function'
    This exception code is returned if the subordinate::
