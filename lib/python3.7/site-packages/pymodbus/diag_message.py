...
#---------------------------------------------------------------------------#
class ReturnSubordinateMessageCountRequest(DiagnosticStatusSimpleRequest):
    '''
    ...
    def execute(self, *args):
        ...
        :returns: The initialized response message
        '''
        count = _MCB.Counter.SubordinateMessage
        return ReturnSubordinateMessageCountResponse(count)


class ReturnSubordinateMessageCountResponse(DiagnosticStatusSimpleResponse):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device, or broadcast, that the remote device has processed since
    its last restart, clear counters operation, or power-up
...
#---------------------------------------------------------------------------#
class ReturnSubordinateNoResponseCountRequest(DiagnosticStatusSimpleRequest):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device, or broadcast, that the remote device has processed since
    its last restart, clear counters operation, or power-up
    ...
    def execute(self, *args):
        ...
        :returns: The initialized response message
        '''
        count = _MCB.Counter.SubordinateNoResponse
        return ReturnSubordinateNoReponseCountResponse(count)


class ReturnSubordinateNoReponseCountResponse(DiagnosticStatusSimpleResponse):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device, or broadcast, that the remote device has processed since
    its last restart, clear counters operation, or power-up
...
#---------------------------------------------------------------------------#
class ReturnSubordinateNAKCountRequest(DiagnosticStatusSimpleRequest):
    '''
    The response data field returns the quantity of messages addressed to the
    ...
    def execute(self, *args):
        ...
        :returns: The initialized response message
        '''
        count = _MCB.Counter.SubordinateNAK
        return ReturnSubordinateNAKCountResponse(count)


class ReturnSubordinateNAKCountResponse(DiagnosticStatusSimpleResponse):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device for which it returned a Negative Acknowledge (NAK) exception
    response, since its last restart, clear counters operation, or power-up.
...
#---------------------------------------------------------------------------#
class ReturnSubordinateBusyCountRequest(DiagnosticStatusSimpleRequest):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device for which it returned a Subordinate Device Busy exception response,
    ...
    def execute(self, *args):
        ...
        :returns: The initialized response message
        '''
        count = _MCB.Counter.SubordinateBusy
        return ReturnSubordinateBusyCountResponse(count)


class ReturnSubordinateBusyCountResponse(DiagnosticStatusSimpleResponse):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device for which it returned a Subordinate Device Busy exception response,
    since its last restart, clear counters operation, or power-up.
...
#---------------------------------------------------------------------------#
class ReturnSubordinateBusCharacterOverrunCountRequest(DiagnosticStatusSimpleRequest):
    '''
    The response data field returns the quantity of messages addressed to the
    ...
    def execute(self, *args):
        ...
        return ReturnSubordinateBusCharacterOverrunCountResponse(count)


class ReturnSubordinateBusCharacterOverrunCountResponse(DiagnosticStatusSimpleResponse):
    '''
    The response data field returns the quantity of messages addressed to the
    remote device that it could not handle due to a character overrun condition,
    since its last restart, clear counters operation, or power-up. A character
...
class ReturnIopOverrunCountResponse(DiagnosticStatusSimpleResponse):
    ...
    addressed to the subordinate that it could not handle due to an 884
...
class GetClearModbusPlusRequest(DiagnosticStatusSimpleRequest):
    ...
    them. Statistics are also cleared on power-up of the subordinate
    device.
    '''
    ...
    def get_response_pdu_size(self):
        ...
        contains the statistics for the Modbus Plus peer processor in the subordinate device.
...
class GetClearModbusPlusResponse(DiagnosticStatusSimpleResponse):
    ...
    the Modbus Plus peer processor in the subordinate device.
    '''
    sub_function_code = 0x0015
...
__all__ = [
    ...
    "ReturnSubordinateMessageCountRequest", "ReturnSubordinateMessageCountResponse",
    "ReturnSubordinateNoResponseCountRequest", "ReturnSubordinateNoReponseCountResponse",
    "ReturnSubordinateNAKCountRequest", "ReturnSubordinateNAKCountResponse",
    "ReturnSubordinateBusyCountRequest", "ReturnSubordinateBusyCountResponse",
    "ReturnSubordinateBusCharacterOverrunCountRequest", "ReturnSubordinateBusCharacterOverrunCountResponse",
