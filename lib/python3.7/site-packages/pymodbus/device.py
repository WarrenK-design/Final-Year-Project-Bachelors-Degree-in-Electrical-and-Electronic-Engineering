...
class ModbusPlusStatistics(object):
    ...
    __data = OrderedDict({
        ...
        'program_main_token_failed'    : [0x00],     # 07 hi
        'data_main_token_failed'       : [0x00],     # 07 lo
        'program_main_token_owner'     : [0x00],     # 08 hi
        'data_main_token_owner'        : [0x00],     # 08 lo
        'program_subordinate_token_owner'      : [0x00],     # 09 hi
        'data_subordinate_token_owner'         : [0x00],     # 09 lo
        'data_subordinate_command_transfer'    : [0x00],     # 10 hi
        '__unused_10_lowbit'             : [0x00],     # 10 lo

        'program_subordinate_command_transfer' : [0x00],     # 11 hi
        'program_main_rsp_transfer'    : [0x00],     # 11 lo
        'program_subordinate_auto_logout'      : [0x00],     # 12 hi
        'program_main_connect_status'  : [0x00],     # 12 lo
        ...
        'data_main_output_path'        : [0x00] * 8, # 38-41
        'data_subordinate_input_path'          : [0x00] * 8, # 42-45
        'program_main_outptu_path'     : [0x00] * 8, # 46-49
        'program_subordinate_input_path'       : [0x00] * 8, # 50-53
    })
...
class ModbusCountersHandler(object):
    ...
    0x0D  3  Return Subordinate Exception Error Count
    ...
    0xOE  4  Return Subordinate Message Count
    ...
    0x0F  5  Return Subordinate No Response Count
    ...
    0x10  6  Return Subordinate NAK Count
    ...
    0x11  7  Return Subordinate Busy Count

             Quantity of messages addressed to the remote device for which it
             returned a Subordinate Device Busy exception response, since its last
    ...
    __names   = [
        ...
        'SubordinateExceptionError',
        'SubordinateMessage',
        'SubordinateNoResponse',
        'SubordinateNAK',
        'SubordinateBusy',
        'BusCharacterOverrun'
        'Event '
    ...
    SubordinateMessage          = dict_property(lambda s: s.__data, 3)
    SubordinateNoResponse       = dict_property(lambda s: s.__data, 4)
    SubordinateNAK              = dict_property(lambda s: s.__data, 5)
    SubordinateBusy             = dict_property(lambda s: s.__data, 6)
