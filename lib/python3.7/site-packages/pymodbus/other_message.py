...
# TODO Make these only work on serial
#---------------------------------------------------------------------------#
class ReportSubordinateIdRequest(ModbusRequest):
    '''
    ...
    def execute(self, context=None):
        ...
        return ReportSubordinateIdResponse(identifier)
    ...
    def __str__(self):
        ...
        :returns: The string representation of the request
        '''
        return "ResportSubordinateIdRequest(%d)" % self.function_code


class ReportSubordinateIdResponse(ModbusResponse):
    '''
    ...
    def __init__(self, identifier=b'\x00', status=True, **kwargs):
        ...
        :param identifier: The identifier of the subordinate
        :param status: The status response to report
        '''
        ModbusResponse.__init__(self, **kwargs)
    ...
    def encode(self):
        ...
        '''
        if self.status:
            status = ModbusStatus.SubordinateOn
        else:
            status = ModbusStatus.SubordinateOff
    ...
    def decode(self, data):
        ...
        self.status = status == ModbusStatus.SubordinateOn
    ...
    def __str__(self):
        ...
        return "ResportSubordinateIdResponse(%s, %s, %s)" % arguments
...
__all__ = [
    ...
    "ReportSubordinateIdRequest", "ReportSubordinateIdResponse",
]
