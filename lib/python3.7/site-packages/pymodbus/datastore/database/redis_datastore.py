...
# Context
#---------------------------------------------------------------------------#
class RedisSubordinateContext(IModbusSubordinateContext):
    '''
    This is a modbus subordinate context using redis as a backing
    store.
    '''
    ...
    def __str__(self):
        ...
        :returns: A string representation of the context
        '''
        return "Redis Subordinate Context %s" % self.client
