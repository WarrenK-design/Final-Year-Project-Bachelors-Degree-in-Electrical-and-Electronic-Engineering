...
class NoSuchSubordinateException(ModbusException):
    """ Error resulting from making a request to a subordinate
    that does not exist """
    ...
    def __init__(self, string=""):
        ...
        :param string: The message to append to the error
        """
        message = "[No Such Subordinate] %s" % string
        ModbusException.__init__(self, message)
...
__all__ = [
    ...
    "ConnectionException", "NoSuchSubordinateException",
